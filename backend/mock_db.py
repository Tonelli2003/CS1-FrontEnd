...
Decisão de arquitetura:
    ...
    Melhoria de performance (adaptada do projeto PYRO//GUARD — app.py):
    - obter_telemetria_historica() agora é decorada com @st.cache_data.
      O Streamlit reexecuta cada página completa a cada interação do usuário.
      Sem cache, o Dashboard chama obter_telemetria_historica() para CADA ativo
      da tabela a cada rerun — 7 ativos × recompute completo = latência visível.
      Com cache, a série histórica de cada TAG é computada uma única vez por
      sessão (ttl=None = vive até reiniciar o app ou o usuário forçar rerun).
      A semente determinística da função garante que o resultado cacheado seja
      idêntico ao que seria recomputado, sem perda de consistência.
"""
...
def init_db() -> None:
    ...
    Sprint 2: os registros agora incluem os campos 'planta',
    'imagem_placa' e 'dados_ocr', compatíveis com a tela de ficha
    técnica expandida e com o requisito de visão computacional.

    O campo 'dados_ocr' simula o retorno de uma IA de OCR que leu
    a placa física do motor, contendo:
        - 'confiabilidade' (float 0.92–0.99): score do modelo;
        - 'texto_extraido' (str): leitura bruta do OCR;
        - 'data_leitura' (str): data da captura da imagem.
        ...
        st.session_state[_DB_KEY] = [
            {
                ...
                "planta": "Área Sul",
                "imagem_placa": (
                    "https://dummyimage.com/300x150/1e1e26/00d2ff.png&text=Placa+Motor+EQ-001"
                ),
                "dados_ocr": {
                    "confiabilidade": 0.97,
                    "texto_extraido": "WEG MOTOR INDUCAO 3 FASES 75kW 380V IP55 LOTE 2024-A",
            ...
            },
            {
                ...
                "planta": "Área Norte",
                "imagem_placa": (
                    "https://dummyimage.com/300x150/1e1e26/00d2ff.png&text=Placa+Bomba+EQ-002"
                ),
                "dados_ocr": {
                    "confiabilidade": 0.94,
                    "texto_extraido": "KSB BOMBA CENTRIFUGA BC-40 15kW 220V 60Hz S/N 00492",
                    "data_leitura": "2026-05-03",
                },
            },
            {
                "TAG": "EQ-003",
                ...
                "planta": "Área Leste",
                "imagem_placa": (
                    "https://dummyimage.com/300x150/1e1e26/00d2ff.png&text=Placa+Compressor+EQ-003"
                ),
                "dados_ocr": {
                    "confiabilidade": 0.96,
                    "texto_extraido": "ATLAS COPCO GA-55 COMPRESSOR PARAFUSO 55kW 380V 60Hz",
                    "data_leitura": "2026-05-05",
                },
            },
            # ------------------------------------------------------------------
            ...
            # ------------------------------------------------------------------
            {
                ...
                "planta": "Área Oeste",
                "imagem_placa": (
                    "https://dummyimage.com/300x150/1e1e26/00d2ff.png&text=Placa+Motor+EQ-004"
                ),
                "dados_ocr": {
                    "confiabilidade": 0.99,
                    "texto_extraido": "SIEMENS SIMOTICS SD 1LE1 110kW 440V IE3 3~ 60Hz IP55",
                    "data_leitura": "2026-05-07",
                },
            },
            {
                "TAG": "EQ-005",
                ...
                "planta": "Área Sul",
                "imagem_placa": (
                    "https://dummyimage.com/300x150/1e1e26/00d2ff.png&text=Placa+Motor+EQ-005"
                ),
                "dados_ocr": {
                    "confiabilidade": 0.95,
                    "texto_extraido": "WEG W22 IE3 MOTOR TRIFASICO 37kW 380V 60Hz IP55 CL.F",
                    "data_leitura": "2026-05-08",
                },
            },
            {
                "TAG": "EQ-006",
                ...
                "planta": "Área Leste",
                "imagem_placa": (
                    "https://dummyimage.com/300x150/1e1e26/00d2ff.png&text=Placa+Bomba+EQ-006"
                ),
                "dados_ocr": {
                    "confiabilidade": 0.92,
                    "texto_extraido": "KSB ETANORM SYT 22kW 220V 60Hz CLASSE PROT IP44 2024",
                    "data_leitura": "2026-05-09",
                },
            },
            {
                "TAG": "EQ-007",
                ...
                "planta": "Área Oeste",
                "imagem_placa": (
                    "https://dummyimage.com/300x150/1e1e26/00d2ff.png&text=Placa+Motor+EQ-007"
                ),
                "dados_ocr": {
                    "confiabilidade": 0.98,
                    "texto_extraido": "SIEMENS SIMOTICS GP 1LA7 5.5kW 220V 3~ IE2 60Hz IP55",
                    "data_leitura": "2026-05-10",
                },
            },
        ]
